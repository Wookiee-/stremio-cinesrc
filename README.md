...
| `CINESRC_PROVIDERS` | `12` | Server pool considered per title (all `us`) |
| `CINESRC_PROBE` | `5` | Top-ranked servers actually probed (first 5 that have the stream, no fallbacks past them) |
